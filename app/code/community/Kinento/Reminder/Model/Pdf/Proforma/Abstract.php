 ...
 */
class Kinento_Reminder_Model_Pdf_Proforma_Abstract extends Mage_Core_Model_Abstract
{
	/**
	 * Order model
	 *
	 ...
	 * Pdf object
	 *
	 * @var Kinento_Reminder_Model_Pdf_Abstract
	 */
	protected $_pdf;
	 ...
	 * Set Pdf model
	 *
	 * @param Kinento_Reminder_Model_Pdf_Abstract $pdf
	 * @return Mage_Sales_Model_Order_Pdf_Items_Abstract
	 */
	public function setPdf( Kinento_Reminder_Model_Pdf_Abstract $pdf ) {
		$this->_pdf = $pdf;
		return $this;
	}
	 ...
	 *
	 * @throws Mage_Core_Exception
	 * @return Kinento_Reminder_Model_Pdf_Abstract
	 */
