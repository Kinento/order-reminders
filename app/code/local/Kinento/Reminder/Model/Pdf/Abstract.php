 ...
 */
class Kinento_Reminder_Model_Pdf_Abstract extends Varien_Object
{
	public $y;
	/**
	...
	protected function _initRenderer( $type ) {
		$node = Mage::getConfig()->getNode( 'global/pdf' );
	 ...
	 * @return Kinento_Reminder_Model_Pdf_Proforma_Abstract
	 */
